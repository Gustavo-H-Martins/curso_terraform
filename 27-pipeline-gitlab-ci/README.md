...
```
cd existing_repo
git remote add origin https://gitlab.com/terraform-basico-ao-avancado/pipeline-gitlab-ci-v2.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/terraform-basico-ao-avancado/pipeline-gitlab-ci-v2/-/settings/integrations)
